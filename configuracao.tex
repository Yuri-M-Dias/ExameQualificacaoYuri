...
\titulo{Arquitetura de Cubo de Dados para Representação de Telemetria de Satélites}
\title{Data Cube Architecture for the representation of satellite telemetry} %% 
