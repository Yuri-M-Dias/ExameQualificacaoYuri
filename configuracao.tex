...
\titulo{Arquitetura de Big Data para Representação de Telemetrias de Satélites}
\title{Big Data Architecture for the representation of satellite telemetry} %% 
\author{Yuri Matheus Dias Pereira\\Mauricio Vieira Ferreira Gonçalves\\Rodrigo Rocha Silva} %% coloque o nome do(s) autor(es)
\descriccao{Relatório Técnico resultado do Exame de Qualificação do Curso de Pós-Graduação em Engenharia e Gerenciamento de Sistemas Espaciais.}
