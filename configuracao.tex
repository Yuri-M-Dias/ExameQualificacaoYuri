...
\titulo{O uso de Cubo de Dados como uma solução de \textit{Big Data} como uma ferramenta para tomada de decisão}
\title{The use of a Data Cube as a Big Data solution as a tool for decision making} %%
\author{Yuri Matheus Dias Pereira\\Mauricio Vieira Ferreira Gonçalves\\Rodrigo Rocha Silva} %% coloque o nome do(s) autor(es)
\descriccao{Relatório Técnico resultado do Exame de Proposta de Dissertação do Curso de Pós-Graduação em Engenharia e Gerenciamento de Sistemas Espaciais.}
\repositorio{} %% repositório onde está depositado este documento - na omissão, será preenchido pelo SID
\tipoDaPublicacao{PRP}	%% tipo da publicação (NTC, RPQ, PRP, MAN, PUD, TDI, TAE e PRE) na ausência do número de série INPE, caso contrário deixar vazio
...
% Columns types to make tables easier
