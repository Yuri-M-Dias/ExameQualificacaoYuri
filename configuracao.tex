...
\titulo{O uso de Cubo de Dados como uma solução de \textit{Big Data} como uma ferramenta de tomada de decisão}
\title{The use of a Data Cube as a Big Data solution as a tool for decision making} %%
\author{Yuri Matheus Dias Pereira} %% coloque o nome do(s) autor(es)
\descriccao{
Exame de Proposta de Dissertação do Curso de Pós-Graduação em Engenharia e Gerenciamento de Sistemas Espaciais.\\
Orientado por: Dr. Mauricio Gonçalves Vieira Ferreira e Dr. Rodrigo Rocha Silva
}
