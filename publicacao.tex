...
%\watermark{V. 0.1} %% use o comando \watermark para identificar a versão de seu documento
%% comente este comando quando for gerar a versão final
\usepackage{rotating}
\usepackage{dsfont}
\usepackage{comment}
% These are my packages
\usepackage{enumitem} % Setnoident
\usepackage{multirow} % For easier comparisons
...
\include{./chapters/03-correlatos}
%\include{./chapters/04-experiment} % Not needed, I guess
\include{./chapters/05-query-partition}
\include{./chapters/06-interval-index}
...
\include{./chapters/anexo-b-interval-intersection}

\inicioAnexo
\include{./chapters/anexo-cronograma}
