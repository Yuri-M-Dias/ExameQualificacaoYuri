...
\section{Análise de Dados em Outros Operadores}\label{ch:corr:ops}
...
\begin{table}[htbp]
	\begin{center}
		\caption{Operadores e Arquiteturas de Big Data}\label{table:bigdataoperators}
...
\begin{figure}[ht]
	\caption{Fluxo de dados em uma arquitetura de Big Data}\label{fig:bigdataflow}
	\vspace{6mm}
	\begin{center}
...
O trabalho de~\cite{silva:2015:abordagensParaCubo} mostra algumas das abordagens de construção do cubo de dados que obtiveram sucessos na literatura, bem como apresenta uma comparação de resultados de algumas das abordagens que vamos apresentar aqui.
Dentre este trabalho, podemos citar:
