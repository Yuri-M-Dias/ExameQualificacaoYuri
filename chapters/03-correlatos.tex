...
{\color{red}
Qual a justificativa para não só simplesmente aplicar essas abordagens? Não vejo uma boa razão, tem que ter um teste para justificar que elas não funcionam...
}
