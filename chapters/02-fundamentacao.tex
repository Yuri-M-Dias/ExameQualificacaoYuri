...
\begin{figure}[!htb]
	...
	\vspace{2mm}
	\begin{center}
		\resizebox{9cm}{!}{\includegraphics{Figuras/DataCube-Fig1.png}}
	\end{center}
	\vspace{1mm}
	\legenda{}
...
A figura~\ref{fig:hasse} demonstra todos os níveis de agregação de um cubo composto das dimensões A, B e C.
