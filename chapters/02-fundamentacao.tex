...
O módulo de serviço compõe tudo necessário para o funcionamento dos equipamentos de bordo, como o sistema de geração de energia, o sistema de comunicação com os solo, o computador de bordo, etc.
A carga útil compõe todos os equipamentos necessários para cumprir a missão, sendo esses sensores, câmeras, telescópios, etc.
...
É importante ressaltar que os dados de telemetria compõe usualmente medidas de sensores nos equipamentos do satélite, informações coletadas pelo computador de bordo (como se um instrumento está ligado ou não), e outros dados cuja coleta foi definida como relevante para a operação do satélite.
Porém, dependendo da missão, outras medidas podem ser classificadas como telemetria, como por exemplo câmeras voltadas para o satélites, radares para a prevenção de colisão, e etc.{\color{red} Citação da câmera dentro do Sentinel?}

Esses dados, diversos como são, devem ser analisados pelos operadores em solo.

Neste trabalho, vamos utilizar apenas dados de telemetria de satélite para a análise.
...
\begin{figure}[!htb]
	...
	\vspace{4mm}
	\begin{center}
		\resizebox{10cm}{!}{\includegraphics{Figuras/bottomup.png}}
	\end{center}
	\vspace{2mm}
	\legenda{}
	\FONTE{~\cite{silva:2015:abordagensParaCubo}}.
